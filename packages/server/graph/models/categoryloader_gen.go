...
type CategoryLoaderConfig struct {
	...
	Fetch func(keys []int) ([]*Category, []error)
...
func (l *CategoryLoader) Load(key int) (*Category, error) {
...
func (l *CategoryLoader) LoadThunk(key int) func() (*Category, error) {
	l.mu.Lock()
...
func (l *CategoryLoader) LoadAll(keys []int) ([]*Category, []error) {
...
// This method should be used if you want one goroutine to make requests to many
// different data loaders without blocking until the thunk is called.
func (l *CategoryLoader) LoadAllThunk(keys []int) func() ([]*Category, []error) {
	results := make([]func() (*Category, error), len(keys))
	for i, key := range keys {
		results[i] = l.LoadThunk(key)
	}
...
func (l *CategoryLoader) Prime(key int, value *Category) bool {
	l.mu.Lock()
	var found bool
...
func (l *CategoryLoader) Clear(key int) {
	l.mu.Lock()
	delete(l.cache, key)
	l.mu.Unlock()
}

func (l *CategoryLoader) unsafeSet(key int, value *Category) {
	if l.cache == nil {
		l.cache = map[int]*Category{}
	}
	l.cache[key] = value
}
...
func (b *categoryLoaderBatch) keyIndex(l *CategoryLoader, key int) int {
